app.factory('config', function ($http, $q) {
	var config = {};
	var rootConfig = {
		appsDomain: 	'test.domain',
		secureUrl: 		'https://the.test.center',
		oauth: 			encodeURI('https://the.test.domain/oauth'),
		parse: {
		...
		google: {
			...
			"project_id": "easy-business-domain",
			"auth_uri": "https://accounts.google.com/o/oauth2/auth",
			"token_uri": "https://accounts.google.com/o/oauth2/token",
			"auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
			"redirect_uris": ["https://root-apex2060.c9users.io/oauth", "https://test.domain/oauth", "http://test.domain/oauth"],
			"javascript_origins": ["https://root-apex2060.c9users.io", "http://test.domain", "https://test.domain"],
		},
		test: 'testing'
	}
